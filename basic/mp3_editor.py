...
class Mp3Panel(wx.Panel):
    ...
    def update_mp3_listing(self, folder_path):
        ...
        for mp3 in mp3s:
            ...
            self.list_ctrl.InsertColumn(index, mp3_object.tag.artist)
            self.list_ctrl.InsertColumn(index, 1, mp3_object.tag.album)
            self.list_ctrl.InsertColumn(index, 2, mp3_object.tag.title)
